...
| 17 | Oefenexamen: Webshop (uitgewerkt) | Vite/pnpm |
| 18 | Oefenexamen: Quiz builder (uitgewerkt) | Vite/pnpm |
| 19 | Slotwoord | — |

> De **oefeningen-oplossingen**, de **projecten** (om te clonen) en de **downloadbare handleiding**
> vind je op de pagina **🔑 Oplossingen & downloads** onderaan de zijbalk.
...
Begin bij **Module 0** (in de zijbalk links).
