...
- **De handleiding** — downloadbaar (PDF + Markdown) op de pagina [🔑 Oplossingen & downloads](#oplossingen).
...
- **Twee oefenexamens (ander thema, zelfde recept)**, elk met een uitgewerkte walkthrough én de
  ...
  - [Oefenexamen: Webshop (uitgewerkt)](#oefenexamen-webshop) —
    voegt **filteren** en een **wijziging terugschrijven naar de database** (korting) toe.
  - [Oefenexamen: Quiz builder (uitgewerkt)](#oefenexamen-quiz) —
